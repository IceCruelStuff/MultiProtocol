...
class Info extends ProtocolInfo {
    ...
    public const CURRENT_PROTOCOL = 120;
    ...
    public const PROTOCOL_137 = 137; // 1.2.0
    public const PROTOCOL_140 = 140; // 1.2.5.11
    public const PROTOCOL_141 = 141; // 1.2.5.x
    public const PROTOCOL_150 = 150; // 1.2.6
    public const PROTOCOL_160 = 160; // 1.2.7
    public const PROTOCOL_200 = 200; // 1.2.10
    public const PROTOCOL_201 = 201; // 1.2.10.x
    public const PROTOCOL_220 = 220; // 1.2.13.5
    public const PROTOCOL_221 = 221; // 1.2.13.8
    public const PROTOCOL_222 = 222; // 1.2.13.10
    public const PROTOCOL_223 = 223; // 1.2.13.54
    public const PROTOCOL_224 = 224; // 1.2.13.11
    public const PROTOCOL_240 = 240; // 1.2.14.2
    public const PROTOCOL_250 = 250; // 1.2.15.1
    public const PROTOCOL_260 = 260; // 1.2.20.1, 1.2.20.2
    public const PROTOCOL_261 = 261; // 1.4.0
    public const PROTOCOL_270 = 270; // 1.5.0.0
    public const PROTOCOL_271 = 271; // 1.5.0.0, 1.5.0.4
    public const PROTOCOL_273 = 273; // 1.5.0.7
    public const PROTOCOL_274 = 274; // 1.5.0.10
    public const PROTOCOL_280 = 280; // 1.6.0.1
    public const PROTOCOL_281 = 281; // 1.6.0.5
    public const PROTOCOL_282 = 282; // 1.6.0.8
    public const PROTOCOL_290 = 290; // 1.7.0.2
    public const PROTOCOL_291 = 291; // 1.7.0.5
    public const PROTOCOL_310 = 310; // 1.8.0.4, 1.8.0.8
    public const PROTOCOL_311 = 311; // 1.8.0.9, 1.8.0.10
    public const PROTOCOL_312 = 312; // 1.8.0.11
    public const PROTOCOL_313 = 313; // 1.8.0 rc1
    public const PROTOCOL_330 = 330; // 1.9.0.0
    public const PROTOCOL_331 = 331; // 1.9.0.2
    public const PROTOCOL_332 = 332; // 1.9.0.3
    public const PROTOCOL_340 = 340; // 1.10.0.3
    ...
    public const PROTOCOL_354 = 354; // 1.11.0.7, 1.11.1, 1.11.2, 1.11.3
    public const PROTOCOL_360 = 360; // 1.12.0.2
    public const PROTOCOL_361 = 361; // 1.12.0.3, 1.12.0.4, 1.12.0.5, 1.12.0.6
    public const PROTOCOL_370 = 370; // 1.13.0.1
    ...
    public const PROTOCOL_388 = 388; // 1.13.0.25
