...
class Info extends ProtocolInfo {
    ...
    const ACCEPTED_PROTOCOLS = [137, 141, 150, 160, 201, 223, 261, 274, 282, 291, 313, 332, 340, 354, 361, 388, 389, 390, 407, 408, 419, 422, 428, 431, 440, 448, 465];
    ...
    const PROTOCOL_431 = 431; // 1.16.220
    const PROTOCOL_440 = 440; // 1.17.0
    const PROTOCOL_448 = 448; // 1.17.10
    const PROTOCOL_465 = 465; // 1.17.30
